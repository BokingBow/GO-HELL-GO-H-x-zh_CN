...
TARGET_DIR = r"F:\Reason\Origin\GO HELL GO 素材\gohellgo_1_4"                                       # 你的游戏资源文件夹（.uasset所在目录）
OUTPUT_ROOT = r"F:\Reason\Origin\GO HELL GO 素材\1_4\Extract"                              # 所有提取结果统一放置的根目录
LIST_FILE = r"F:\Reason\Origin\GO HELL GO 素材\to\filelist_1_4.txt"                           # 记录需要提取的.uasset清单（每行一个相对路径）
# ========================================================
