...
__已经确认暂不支持官方发布的升级用补丁，若强行加载将导致游戏崩溃。（可能）将在未来修复。__

请在 Release 中下载 `ChineseTest_P.pak` ，将其置于以下路径：  
...
- 确保 UI 中的所有文本得到翻译且不致使崩溃
- 替换图片中的文本
- 繁简转换与漏翻修正
- 严格人名统一
- 最终润色

若有帮忙意愿……~~我还没有准备好工作分配的相关事宜。但您可以加入 H-x 汉化组的群聊以获取更多信息。~~  
更准确的说法是，游戏将于 6.25 发售“业”版本，我不认为目前有计划工作分配的必要。当然群聊还是能加的。
